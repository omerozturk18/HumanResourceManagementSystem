...
public class NKUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NKUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NKUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NKUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NKUDateTimeConverter dateTimeConverter = new NKUStandardDateTimeConverter();

    public NKUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NKUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NKUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NKUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NKUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NKUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
