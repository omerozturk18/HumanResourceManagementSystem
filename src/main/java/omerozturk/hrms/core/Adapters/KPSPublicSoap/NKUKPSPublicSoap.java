...
public class NKUKPSPublicSoap
{
    ...
    public NKUKPSPublicSoap(){}

    public NKUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NKUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NKUExtendedSoapSerializationEnvelope envelope= new NKUExtendedSoapSerializationEnvelope(NKUExtendedSoapSerializationEnvelope.VER11);
