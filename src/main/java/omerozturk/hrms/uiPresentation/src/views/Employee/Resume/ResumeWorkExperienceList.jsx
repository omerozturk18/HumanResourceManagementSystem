...
export default function ResumeWorkExperienceList({ color }) {
        ...
        >
            ...
            <div className="block w-full overflow-x-auto">
                ...
                <table className="items-center w-full bg-transparent border-collapse">
                    ...
                    <tbody>
                        {
                            resume.workExperiences != null ? resume.workExperiences.map(workExperience => (
                                <tr>
                                    ...
                                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                        <i className="fas fa-circle text-orange-500 mr-2"></i> {workExperience.dateOfStart}
                                    </td>
                                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
